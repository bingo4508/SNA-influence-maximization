...
if __name__ == '__main__':
    ...
    for i in range(0, max_iter):
        ...
        try:
            ...
            my_s.test(1, abspath(nodes_file), abspath(edges_file), abspath(status_file), abspath(selected_nodes_file), str(nodes_num_per_iter), str(time_limit_this_round))
        ...
        # li = [2037, 3437, 1684, 0, 107, 363, 686, 3263, 823, 414]
        # selected_nodes_list = model.select_nodes(li, player_id = 0)
